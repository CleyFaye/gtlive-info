...
TASKS = [
    ...
    {'name': 'synctree',
     ...
     'args': {'sourceDir': 'collected_static/admin',
              'destDir': 'statics/admin',
              },
     },
    {'name': 'synctree',
     'desc': 'Copying raw files',
     'args': {'sourceDir': 'collected_static/raw',
              'destDir': 'statics/raw',
              },
     },
    {'name': 'css',
     'desc': 'Parse CSS files',
     'args': {'sourceDir': 'collected_static/css',
    ...
    {'name': 'img',
     'desc': 'Process images',
     'args': {'sourceDir': 'collected_static/img',
              'destinationDir': 'statics/img',
              },
     },
    {'name': 'js',
     'desc': 'Process Javascript',
     'args': {'sourceDir': 'collected_static/js',
